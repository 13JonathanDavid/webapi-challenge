...
- [ ] Describe Middleware?
everything is middleware it seems. but middleware runs between actions. useful for validation or cleanup.
- [ ] Describe a Resource?
everything is a resource(tm). images, data, stuff the db especially.
